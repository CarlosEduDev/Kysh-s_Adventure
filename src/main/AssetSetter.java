...
public class AssetSetter {
    ...
    public void setInteractiveTile(){
        ...
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 12, 41);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 13, 41);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 13, 40);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 14, 40);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 14, 40);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 15, 40);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 16, 40);
        i++;
        gp.iTile[i] = new IT_DryTree(gp, 17, 40);
        i++;
    }
